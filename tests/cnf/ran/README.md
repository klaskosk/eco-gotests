...
| [ztp](ztp/ztp_suite_test.go)                                     | Tests zero touch provisioning (ZTP) and Argo CD     |
...
| [ranhelper](internal/ranhelper/ranhelper.go)         | Common helpers, currently just for checking pod health      |
