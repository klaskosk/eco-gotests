# Test Case Summary for Simultaneous SNO Deprovisioning with Different Cluster Templates

Test case "Verifies the successful E2E simultaneous deprovisioning of SNO clusters with different cluster templates" is located in tests/system-tests/o-cloud/tests/sno-provisioning-ai.go and is named "It verifies the successful E2E simultaneous deprovisioning of SNO clusters with different cluster templates".

## Goal

The goal of this test case is to verify the successful end-to-end simultaneous deprovisioning of two SNO clusters that were provisioned using different cluster templates.

## Test Setup

This test case assumes two SNO clusters have been successfully provisioned with different cluster templates and their provisioning requests are fulfilled.
...
2. Verify that both `provisioningRequest1` and `provisioningRequest2` are using different cluster template names and versions.
