# Test Case Summary for 80493

Test case 80493 is located in tests/cnf/ran-deployment/deploymenttypes/tests/deployment-types.go and is named "checks if deployment method is SiteConfig".

## Goal

The goal of this test case is to verify if the cluster deployment method is SiteConfig.
...
2. If `deploymentMethod` is not `SiteConfig`, skip the test.
3. Log that the install method is `SiteConfig`.
