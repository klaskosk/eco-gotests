...
require github.com/rh-ecosystem-edge/eco-goinfra v0.0.0-20260810131712-518ae9ae1ba8
...
replace (
	...
	github.com/rh-ecosystem-edge/eco-goinfra => github.com/klaskosk/eco-goinfra v0.0.0-20260814145625-841fe67c11bc // oran-omnibus
