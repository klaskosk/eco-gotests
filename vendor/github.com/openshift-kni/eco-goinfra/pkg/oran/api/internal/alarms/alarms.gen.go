...
type ClientInterface interface {
	// AmNotificationWithBody request with any body
	AmNotificationWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	AmNotification(ctx context.Context, body AmNotificationJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)

	// HwNotificationWithBody request with any body
	HwNotificationWithBody(ctx context.Context, hwVendorName string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	HwNotification(ctx context.Context, hwVendorName string, body HwNotificationJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) AmNotificationWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewAmNotificationRequestWithBody(c.Server, contentType, body)
	if err != nil {
		return nil, err
	}
...
func (c *Client) AmNotification(ctx context.Context, body AmNotificationJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewAmNotificationRequest(c.Server, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) HwNotificationWithBody(ctx context.Context, hwVendorName string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewHwNotificationRequestWithBody(c.Server, hwVendorName, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) HwNotification(ctx context.Context, hwVendorName string, body HwNotificationJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewHwNotificationRequest(c.Server, hwVendorName, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewAmNotificationRequest calls the generic AmNotification builder with application/json body
func NewAmNotificationRequest(server string, body AmNotificationJSONRequestBody) (*http.Request, error) {
	...
	return NewAmNotificationRequestWithBody(server, "application/json", bodyReader)
}

// NewAmNotificationRequestWithBody generates requests for AmNotification with any type of body
func NewAmNotificationRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/internal/v1/caas-alerts/alertmanager")
	if operationPath[0] == '/' {
...
// NewHwNotificationRequest calls the generic HwNotification builder with application/json body
func NewHwNotificationRequest(server string, hwVendorName string, body HwNotificationJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewHwNotificationRequestWithBody(server, hwVendorName, "application/json", bodyReader)
}

// NewHwNotificationRequestWithBody generates requests for HwNotification with any type of body
func NewHwNotificationRequestWithBody(server string, hwVendorName string, contentType string, body io.Reader) (*http.Request, error) {
	var err error

	var pathParam0 string

	pathParam0, err = runtime.StyleParamWithLocation("simple", false, "hwVendorName", runtime.ParamLocationPath, hwVendorName)
	if err != nil {
		return nil, err
	}
	...
	operationPath := fmt.Sprintf("/internal/v1/hardware-alerts/%s", pathParam0)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
type ClientWithResponsesInterface interface {
	// AmNotificationWithBodyWithResponse request with any body
	AmNotificationWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*AmNotificationResponse, error)

	AmNotificationWithResponse(ctx context.Context, body AmNotificationJSONRequestBody, reqEditors ...RequestEditorFn) (*AmNotificationResponse, error)

	// HwNotificationWithBodyWithResponse request with any body
	HwNotificationWithBodyWithResponse(ctx context.Context, hwVendorName string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*HwNotificationResponse, error)

	HwNotificationWithResponse(ctx context.Context, hwVendorName string, body HwNotificationJSONRequestBody, reqEditors ...RequestEditorFn) (*HwNotificationResponse, error)
...
type AmNotificationResponse struct {
	Body         []byte
	HTTPResponse *http.Response
}

// Status returns HTTPResponse.Status
func (r AmNotificationResponse) Status() string {
...
func (r AmNotificationResponse) StatusCode() int {
	if r.HTTPResponse != nil {
...
type HwNotificationResponse struct {
	Body         []byte
	HTTPResponse *http.Response
}

// Status returns HTTPResponse.Status
func (r HwNotificationResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r HwNotificationResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// AmNotificationWithBodyWithResponse request with arbitrary body returning *AmNotificationResponse
func (c *ClientWithResponses) AmNotificationWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*AmNotificationResponse, error) {
	rsp, err := c.AmNotificationWithBody(ctx, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseAmNotificationResponse(rsp)
}

func (c *ClientWithResponses) AmNotificationWithResponse(ctx context.Context, body AmNotificationJSONRequestBody, reqEditors ...RequestEditorFn) (*AmNotificationResponse, error) {
	rsp, err := c.AmNotification(ctx, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseAmNotificationResponse(rsp)
...
// HwNotificationWithBodyWithResponse request with arbitrary body returning *HwNotificationResponse
func (c *ClientWithResponses) HwNotificationWithBodyWithResponse(ctx context.Context, hwVendorName string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*HwNotificationResponse, error) {
	rsp, err := c.HwNotificationWithBody(ctx, hwVendorName, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseHwNotificationResponse(rsp)
}

func (c *ClientWithResponses) HwNotificationWithResponse(ctx context.Context, hwVendorName string, body HwNotificationJSONRequestBody, reqEditors ...RequestEditorFn) (*HwNotificationResponse, error) {
	rsp, err := c.HwNotification(ctx, hwVendorName, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseHwNotificationResponse(rsp)
...
// ParseAmNotificationResponse parses an HTTP response from a AmNotificationWithResponse call
func ParseAmNotificationResponse(rsp *http.Response) (*AmNotificationResponse, error) {
	...
	response := &AmNotificationResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
// ParseHwNotificationResponse parses an HTTP response from a HwNotificationWithResponse call
func ParseHwNotificationResponse(rsp *http.Response) (*HwNotificationResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &HwNotificationResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
