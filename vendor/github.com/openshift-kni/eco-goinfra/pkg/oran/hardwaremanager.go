...
func (builder *HardwareManagerBuilder) Exists() bool {
	...
	glog.V(100).Infof("Checking if HardwareManager %s exists in namespaces %s",
		builder.Definition.Name, builder.Definition.Namespace)
...
func (builder *HardwareManagerBuilder) Update(force bool) (*HardwareManagerBuilder, error) {
	...
	glog.V(100).Infof("Updating HardwareManager %s in namespaces %s",
		builder.Definition.Name, builder.Definition.Namespace)
...
func (builder *HardwareManagerBuilder) Delete() error {
	...
	glog.V(100).Infof("Deleting HardwareManager %s in namespaces %s",
		builder.Definition.Name, builder.Definition.Namespace)

	if !builder.Exists() {
		glog.V(100).Infof("HardwareManager %s in namespaces %s does not exist",
			builder.Definition.Name, builder.Definition.Namespace)
...
func (builder *HardwareManagerBuilder) WaitForCondition(
	...
	glog.V(100).Infof("Waiting up to %s until HardwareManager %s in namespaces %s has condition %v",
